			...
			<table class= "mobile">
				...
				<tr class= "pagesearch" height="5%">
					<td style= "text-align: left;">
						&nbsp;&nbsp;
						课程名称：
						<input type= "text" name= "kcName" style= "width:100px;">
						&nbsp;&nbsp;
						课程星期：
						<input type= "text" name= "kcxq" style= "width:100px;">
						&nbsp;&nbsp;
						课程属性：
						<input type= "text" name= "kcsx" style= "width:100px;">
						&nbsp;&nbsp;
						课程节次：
						<input type= "text" name= "kcjs" style= "width:100px;">
						<input type= "button" class= "btn" value= "查 询 " onClick= "sch();" />
						
						<c:choose>
							<c:when test="${param.flag==1 }">&nbsp;&nbsp;
						<input type= "button" class= "btn" value= "新 增 " onClick= "add();" /></c:when>
