...
<div class="login-container">
	...
	<form action="" method="post" id="registerFormstudent" style="display: none;">
		...
		<div>
<input type="text" class="username" placeholder="姓名" id="studentName" name="studentName"/>
		</div>
		<div>
<select class="username" id="bjId" name="bjId">
							<c:forEach items="${bjList }" var="lists">
								<option value="${lists.id }">${lists.bjName
									}</option>
							</c:forEach>
					</select>
		</div>
...
<input type="text" class="username" placeholder="电话" id="phone" name="phone"/>
		...
		<div>
<input type="text" class="username" placeholder="QQ" id="qq" name="qq"/>
		</div>
		<div>
<input type="text" class="username" placeholder="邮箱" id="email" name="email"/>
		</div>
		<div>
		</div>
	...
	<form action="" method="post" id="registerFormteacher" style="display: none;">
		...
		<div>
<input type="text" class="username" placeholder="姓名" id="teacherName" name="teacherName"/>
		</div>
		<div>
<input type="text" class="username" placeholder="年龄" id="age" name="age"/>
		</div>
