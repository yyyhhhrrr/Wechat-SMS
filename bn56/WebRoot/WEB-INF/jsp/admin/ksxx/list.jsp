...
<html>
	<body>
		<display:table name="list"
			...
			<display:column title="考试日期">
				<fmt:formatDate value="${row.showDate}" type="date" pattern="yyyy-MM-dd HH：mm：ss"/>	</display:column>
			<display:column title="考试地点" property="ksdd"/>
						<c:choose>
	...
	function updateColumnckId(kcId,id){
		if(!confirm("确定要更新为"+kcId+"吗?")){
			return false;
		}
		//var aaa = prompt("请输入操作意见或说明：","");
		var params={id:id,kcId:kcId};
